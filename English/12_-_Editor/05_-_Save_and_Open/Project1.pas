...
Für das einfache speichern, muss man nicht viel machen. Man muss nur das Event <b>cmSave</b> aufrufen, zB. über das Menu.
*)
//lineal
program Project1;
...
(*
Im Menu sind die neuen Datei-Funktionen dazugekommen.
*)
//code+
