...
begin
  ...
  Collection^.Insert(NewStr('Monday'));
  Collection^.Insert(NewStr('Tuesday'));
  Collection^.Insert(NewStr('Wednesday'));
  Collection^.Insert(NewStr('Thursday'));
  Collection^.Insert(NewStr('Friday'));
  Collection^.Insert(NewStr('Saturday'));
  Collection^.Insert(NewStr('Sunday'));
