...
begin
  ...
  StringCollection^.Insert(NewStr('Monday'));
  StringCollection^.Insert(NewStr('Tuesday'));
  StringCollection^.Insert(NewStr('Wednesday'));
  StringCollection^.Insert(NewStr('Thursday'));
  StringCollection^.Insert(NewStr('Friday'));
  StringCollection^.Insert(NewStr('Saturday'));
  StringCollection^.Insert(NewStr('Sunday'));
