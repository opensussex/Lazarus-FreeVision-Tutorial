...
(*
Add buttons to the dialog.
With <b>Insert</b> you add components, in this case the buttons.
With bfDefault you set the default button, which is activated with <b>[Enter]</b>.
bfNormal is a regular button.
The dialog is now opened modally, so <b>no</b> other dialogs can be opened.
dummy has the value of the button that was pressed, this corresponds to the <b>cmxxx</b> value.
The height of buttons must always be <b>2</b>, otherwise there will be incorrect display.
*)
  //code+
